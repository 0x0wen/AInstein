...
import { Upload, Play, Download, Share2, Clock, CheckCircle, AlertCircle } from "lucide-react"
        ...
        <TabsContent value="create" className="mt-0">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload a problem or concept you'd like explained, and AInstein will create a video explanation.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
                ...
                <p className="text-xs text-muted-foreground mb-6">Supports PDF, DOCX, JPG, PNG (Max 10MB)</p>
