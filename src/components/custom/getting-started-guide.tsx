...
export function GettingStartedGuide() {
  const steps = [
    {
      ...
      description: "Start by creating a Study Kit for your subject or topic of interest",
    },
    {
    ...
    },
    {
      ...
      description: "Upload problems and get video explanations to understand concepts better",
    },
    {
  ...
  return (
    <section className="my-16">
      <h2 className="text-2xl font-bold text-center mb-12">Getting Started with AInstein</h2>
