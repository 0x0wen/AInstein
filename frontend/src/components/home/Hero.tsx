    ...
    <section className="flex flex-col justify-center items-center w-screen h-screen">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="relative aspect-square border-4 border-white rounded-full hover:scale-90 group transition-all duration-300">
          <div className="absolute w-full h-full bg-black/50 font-bold text-2xl z-10 rounded-full flex justify-center items-center group-hover:opacity-100 opacity-0 transition-all duration-300">
            <p>Chatbot</p>
          </div>
          <MetaBalls
            color="#ffffff"
        ...
        <div className="relative aspect-square border-4 border-white rounded-4xl overflow-hidden hover:scale-90 group transition-all duration-300">
          <div className="absolute w-full h-full bg-black/50 font-bold text-2xl z-10 rounded-4xl flex justify-center items-center group-hover:opacity-100 opacity-0 transition-all duration-300">
            <p>Flashcards</p>
          </div>
          <Waves
            lineColor="#fff"
        ...
        <div className="relative aspect-square border-4 border-white rounded-full overflow-hidden hover:scale-90 group transition-all duration-300">
          <div className="absolute w-full h-full bg-black/50 font-bold text-2xl z-10 flex rounded-full justify-center items-center group-hover:opacity-100 opacity-0 transition-all duration-300">
            <p>Videos</p>
          </div>
          <Squares
            speed={0.1}
