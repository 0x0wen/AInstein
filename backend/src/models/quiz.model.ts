...
const QuizQuestionZodSchema = z.object({
  ...
  options: z.array(z.string()).min(2, { message: "At least two options required" }),
  correctOption: z.number().min(0, { message: "Correct option index must be valid" }),
...
export const QuizRequestSchema = z.object({
  ...
  questions: z.array(QuizQuestionZodSchema).min(1, { message: "At least one question required" })
});
